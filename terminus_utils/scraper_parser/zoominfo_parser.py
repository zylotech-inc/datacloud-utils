...
def scrape_company_info(soup: BeautifulSoup) -> dict:
    """
    ...
    Returns:
        dict: A dictionary containing various details about the company, such as:
              - name: The company's name
              - industry: The industry or business type of the company
              - terminus_industry_label: The standardized industry label
              - industry_status: The status of the industry mapping
              - employee_size: The size of the company's workforce
              - address: The headquarters address of the company
              - phone: The contact phone number of the company
              - website: The company's website URL
              - revenue: The company's revenue
              - sic: The SIC code of the company
              - naics: The NAICS code of the company
              - description: A description of the company
              - linkedin_link: The company's LinkedIn profile URL
              - facebook_link: The company's Facebook profile URL
              - twitter_link: The company's Twitter profile URL
              - ticker: The stock ticker symbol of the company
              - funding: The total funding amount received by the company
              - topic_score: A dictionary of topic intent scores
              - tech_stack: The technology stack used by the company
              - products: A list of products offered by the company
              - competitor: A dictionary of competitors with their employee count and revenue
              - acquisition: A list of acquisitions and subsidiaries
              - contacts: A dictionary of key contacts with their names and job titles
    ...
    try:
        ...
        company_desc = company_desc_el.text if company_desc_el else None
        ...
        company_address = ' '.join([each.text for each in address_phone_ticker_list if
        ...
        company_address = company_address.replace('Headquarters', '').strip()
        if "..." in company_address:
            address_elm = soup.find(class_="answer is-open")
            company_address = address_elm.text.strip().split('located at')[-1
                                                                           ] if address_elm else ""
        ...
        result = {'name': company_name, 'industry': industry,
                  ...
                  company_naics, 'description': company_desc, 'funding': funding, 'links': ({
                      'linkedin_url': linkedin_link, 'facebook_url': facebook_link, 'twitter_ur':
        ...
        logger.error("Unexpected exception occured: ", exc_info=True)
        return result
